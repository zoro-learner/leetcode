...
//Given an array of positive integers arr, find a pattern of length m that is re
//peated k or more times. 
//
// A pattern is a subarray (consecutive sub-sequence) that consists of one or mo
//re values, repeated multiple times consecutively without overlapping. A pattern 
...
//Output: true
//Explanation: The pattern (4) of length 1 is repeated 4 consecutive times. Noti
//ce that pattern can be repeated k or more times but not less.
// 
//
// Example 2: 
//
